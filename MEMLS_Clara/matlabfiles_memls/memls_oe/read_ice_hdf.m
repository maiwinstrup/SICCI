...
icediff=data.HDFEOS.GRIDS.NpPolarGrid25km.Data_Fields.SI_25km_NH_ICEDIFF_DAY;
    ...
    SDlise = 1.7701 + 0.017462.*Tb6v - 0.02801.*Tb18v + 0.0040926.*Tb36v;
...
r=imagesc((SDlise+land)',climits)
r=colobar("east");
saveas(r,'RRreg_20170419.png');
l=imagesc((SDlise+land)',climits)
l=colobar("east");
saveas(l,'RRlise_20170419.png');
%hist(spv,10);
end
